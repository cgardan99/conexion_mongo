...
mongoose.asistencia_h_1 = mongoose.createConnection(process.env.DB_ASISTENCIA_H_1);
mongoose.asistencia_h_2 = mongoose.createConnection(process.env.DB_ASISTENCIA_H_2);
